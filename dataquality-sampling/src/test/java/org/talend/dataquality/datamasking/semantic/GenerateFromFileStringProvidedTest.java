...
public class GenerateFromFileStringProvidedTest {
    ...
    public void testInit() {
        ...
        gfls.parse("commune.txt", true, new Random(AllDataqualitySamplingTests.RANDOM_SEED)); //$NON-NLS-1$
        ...
        gfls.parse("company.txt", true, new Random(AllDataqualitySamplingTests.RANDOM_SEED)); //$NON-NLS-1$
        ...
        gfls.parse("firstName.txt", true, new Random(AllDataqualitySamplingTests.RANDOM_SEED)); //$NON-NLS-1$
        ...
        gfls.parse("lastName.txt", true, new Random(AllDataqualitySamplingTests.RANDOM_SEED)); //$NON-NLS-1$
        ...
        gfls.parse("organization.txt", true, new Random(AllDataqualitySamplingTests.RANDOM_SEED)); //$NON-NLS-1$
